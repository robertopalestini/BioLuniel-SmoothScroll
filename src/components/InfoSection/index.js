...
const InfoSection = ({lightBg, id, imgStart, topLine, lighText, headLine, darkText, description, descriptiontwo, descriptionthree, descriptionfour, descriptionfive, img, alt, primary, dark, dark2}) => {
    return (
        <>
